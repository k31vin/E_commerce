...
<div class="container mt-5">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_title" class="form-control" name="product_title" value="<?php echo $product_title ?>" require="required">
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_description" class="form-label">Product Description</label>
            <input type="text" id="product_description" class="form-control" name="product_description" value="<?php echo $product_description ?>" require="required">
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_keywords" class="form-label">Product Keywords</label>
            <input type="text" id="product_keywords" value="<?php echo $product_keywords ?>" class="form-control" name="product_keywords" require="required">
        </div>
        <div class="form-outline w-50 m-auto mb-4">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_price" class="form-control" name="product_price" value="<?php echo $product_price; ?>" require="required">
        </div>
...
if (isset($_POST['edit_product'])) {
    ...
    if ($product_title == '' or $product_description == '' or $product_keywords == '' or $product_category == ''
        or $product_brands == '' or $product_image2 == '' or $product_image3 == '' or $product_price == '') {
        echo "<script>alert('Please fill all the fields to submit successfully')</script>";
    } else {
